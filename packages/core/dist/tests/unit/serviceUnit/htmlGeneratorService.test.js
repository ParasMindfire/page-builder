import { EditorChromeSanitizer, HtmlShellBuilder, StyleCollector, SvgStamper, } from '../../../services/HtmlGeneratorService.js';
...
describe('HTML Export Pipeline - Integrated Unit Tests', () => {
    ...
    describe('EditorChromeSanitizer', () => {
      ...
      `;
        ...
        it('should strip all editor-specific nodes and attributes', () => {
            ...
            expect((_a = root.querySelector('#comp')) === null || _a === void 0 ? void 0 : _a.hasAttribute('contenteditable')).toBe(false);
        });
    });
    // 2. SvgStamper Tests
    describe('SvgStamper', () => {
    ...
    describe('HtmlShellBuilder', () => {
        ...
        it('should wrap content in a valid HTML5 shell', () => {
            const result = builder.build('<div>Content</div>', '/* head */', '/* generated */');
