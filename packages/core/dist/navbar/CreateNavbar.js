import { getLeftButtons, getRightButtons, buildLeftContainer, buildRightContainer, } from './CreateNavbarCore.js';
/* Builds and returns the full navbar element */
export function createNavbar(editable, brandTitle = 'Page Builder', showAttributeTab) {
    ...
    const rightContainer = buildRightContainer(getRightButtons(editable, showAttributeTab));
