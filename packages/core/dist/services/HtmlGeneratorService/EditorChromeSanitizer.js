import { EDITOR_ATTRS_TO_STRIP, EDITOR_CLASSES_TO_REMOVE, EDITOR_NODES_SELECTOR, SVG_ACCESSIBILITY_SELECTOR, } from './../../constants.js';
...
export class EditorChromeSanitizer {
    ...
    removeMuiRatingInternals(root) {
        root
            .querySelectorAll('[class*="MuiRating-label"]')
            .forEach(labelSpan => {
            labelSpan
