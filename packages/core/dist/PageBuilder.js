...
import { syntaxHighlightHTML, syntaxHighlightCSS, } from './utils/utilityFunctions.js';
import './styles/main.css';
export class PageBuilder {
    constructor(dynamicComponents = { Basic: [], Extra: [], Custom: {} }, initialDesign = null, editable = true, brandTitle, showAttributeTab, layoutMode = 'grid') {
    ...
    setupInitialComponents() {
        ...
        Canvas.init(this.initialDesign, this.editable, this.dynamicComponents.Basic, this.layoutMode);
        this.sidebar.init();
        ShortcutManager.init();
        CustomizationSidebar.init(this.dynamicComponents.Custom, this.editable, this.dynamicComponents.Basic, this.showAttributeTab);
    ...
    setupExportHTMLButton() {
        ...
        exportButton.addEventListener('click', () => {
            ...
            const modal = createExportModal(highlightedHTML, highlightedCSS, html, css);
