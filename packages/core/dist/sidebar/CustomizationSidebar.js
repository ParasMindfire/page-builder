...
import { buildTabToggle, switchToCustomizeMode, switchToAttributeMode, populateCssControls, handleInputTrigger, populateFunctionalityControls, addControlListeners, } from './CustomizationSidebarCore.js';
export class CustomizationSidebar {
    static init(customComponentsConfig, editable, BasicComponent, showAttributeTab) {
        ...
        this.sidebarElement.insertBefore(this.layersModeToggle, this.componentNameHeader);
    ...
    static switchToCustomizeModeLocal() {
        switchToCustomizeMode(this.controlsContainer, this.functionsPanel, this.componentNameHeader);
        if (this.selectedComponent)
            this.populateCssControlsLocal(this.selectedComponent);
    }
    /* Delegates to module, then re-populates functionality controls */
    static switchToAttributeModeLocal() {
        switchToAttributeMode(this.controlsContainer, this.functionsPanel, this.componentNameHeader);
        if (this.selectedComponent)
    ...
    static populateCssControlsLocal(component) {
        populateCssControls(component, this.controlsContainer, c => addControlListeners(c, this.controlsContainer, cc => this.populateCssControlsLocal(cc)));
    }
    /* Thin wrapper that passes all required state into the module function */
    static populateFunctionalityControlsLocal(component) {
        populateFunctionalityControls(component, this.functionsPanel, this.basicComponentsConfig, this.customComponentsConfig, this.editable, event => handleInputTrigger(this.selectedComponent, this.basicComponentsConfig, this.functionsPanel));
    }
