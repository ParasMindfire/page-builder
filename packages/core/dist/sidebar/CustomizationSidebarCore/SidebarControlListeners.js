...
export function addControlListeners(component, controlsContainer, addListenersFn /* recursive ref for re-populate */) {
    ...
    (_f = get('font-size')) === null || _f === void 0 ? void 0 : _f.addEventListener('input', () => {
        var _a;
        const unit = ((_a = get('font-size-unit')) === null || _a === void 0 ? void 0 : _a.value) || 'px';
        component.style.fontSize = `${get('font-size').value}${unit}`;
        captureStateDebounced();
    });
    (_g = get('font-weight')) === null || _g === void 0 ? void 0 : _g.addEventListener('change', () => {
        component.style.fontWeight = get('font-weight').value;
        captureStateDebounced();
    });
    (_h = get('font-family')) === null || _h === void 0 ? void 0 : _h.addEventListener('change', () => {
        component.style.fontFamily = get('font-family').value;
        captureStateDebounced();
    });
    /* ── Text color — two-way sync ───────────────────────────────────────────── */
    (_j = get('text-color')) === null || _j === void 0 ? void 0 : _j.addEventListener('input', () => {
    ...
    (_k = get('text-color-value')) === null || _k === void 0 ? void 0 : _k.addEventListener('input', e => {
        const val = e.target.value;
        component.style.color = val;
    ...
    /* ── Border ──────────────────────────────────────────────────────────────── */
    (_l = get('border-width')) === null || _l === void 0 ? void 0 : _l.addEventListener('input', () => {
        var _a;
    ...
    (_m = get('border-style')) === null || _m === void 0 ? void 0 : _m.addEventListener('change', () => {
        component.style.borderStyle = get('border-style').value;
        captureStateDebounced();
    });
    (_o = get('border-color')) === null || _o === void 0 ? void 0 : _o.addEventListener('input', () => {
    ...
    (_p = get('border-color-value')) === null || _p === void 0 ? void 0 : _p.addEventListener('input', e => {
        const val = e.target.value;
        component.style.borderColor = val;
    ...
    (_q = get('display')) === null || _q === void 0 ? void 0 : _q.addEventListener('change', () => {
    ...
    /* ── Flex sub-controls ───────────────────────────────────────────────────── */
    (_r = get('flex-direction')) === null || _r === void 0 ? void 0 : _r.addEventListener('change', () => {
        component.style.flexDirection =
            get('flex-direction').value;
        captureStateDebounced();
    });
    (_s = get('align-items')) === null || _s === void 0 ? void 0 : _s.addEventListener('change', () => {
        component.style.alignItems = get('align-items').value;
        captureStateDebounced();
    });
    (_t = get('justify-content')) === null || _t === void 0 ? void 0 : _t.addEventListener('change', () => {
