...
export function addControlListeners(component, controlsContainer, addListenersFn /* recursive ref for re-populate */) {
    ...
    /* ── Spacing ─────────────────────────────────────────────────────────────── */
    (_e = get('margin')) === null || _e === void 0 ? void 0 : _e.addEventListener('input', () => {
        var _a;
        const unit = ((_a = get('margin-unit')) === null || _a === void 0 ? void 0 : _a.value) || 'px';
        component.style.margin = `${get('margin').value}${unit}`;
        captureStateDebounced();
    });
    (_f = get('padding')) === null || _f === void 0 ? void 0 : _f.addEventListener('input', () => {
        var _a;
        const unit = ((_a = get('padding-unit')) === null || _a === void 0 ? void 0 : _a.value) || 'px';
        component.style.padding = `${get('padding').value}${unit}`;
        captureStateDebounced();
    });
    /* ── Typography ──────────────────────────────────────────────────────────── */
    (_g = get('alignment')) === null || _g === void 0 ? void 0 : _g.addEventListener('change', () => {
        component.style.textAlign = get('alignment').value;
        captureStateDebounced();
    });
    (_h = get('font-size')) === null || _h === void 0 ? void 0 : _h.addEventListener('input', () => {
        var _a;
        const unit = ((_a = get('font-size-unit')) === null || _a === void 0 ? void 0 : _a.value) || 'px';
        component.style.fontSize = `${get('font-size').value}${unit}`;
        captureStateDebounced();
    });
    (_j = get('font-weight')) === null || _j === void 0 ? void 0 : _j.addEventListener('change', () => {
        component.style.fontWeight = get('font-weight').value;
        captureStateDebounced();
    });
    (_k = get('font-family')) === null || _k === void 0 ? void 0 : _k.addEventListener('change', () => {
        component.style.fontFamily = get('font-family').value;
        captureStateDebounced();
    });
    /* ── Text color — two-way sync ───────────────────────────────────────────── */
    (_l = get('text-color')) === null || _l === void 0 ? void 0 : _l.addEventListener('input', () => {
    ...
    (_m = get('text-color-value')) === null || _m === void 0 ? void 0 : _m.addEventListener('input', e => {
        const val = e.target.value;
        component.style.color = val;
    ...
    /* ── Border ──────────────────────────────────────────────────────────────── */
    (_o = get('border-width')) === null || _o === void 0 ? void 0 : _o.addEventListener('input', () => {
        var _a;
    ...
    (_p = get('border-style')) === null || _p === void 0 ? void 0 : _p.addEventListener('change', () => {
        component.style.borderStyle = get('border-style').value;
        captureStateDebounced();
    });
    (_q = get('border-color')) === null || _q === void 0 ? void 0 : _q.addEventListener('input', () => {
    ...
    (_r = get('border-color-value')) === null || _r === void 0 ? void 0 : _r.addEventListener('input', e => {
        const val = e.target.value;
        component.style.borderColor = val;
    ...
    (_s = get('display')) === null || _s === void 0 ? void 0 : _s.addEventListener('change', () => {
        ...
        requestAnimationFrame(() => populateCssControls(component, controlsContainer, addListenersFn));
    });
    /* ── Flex sub-controls ───────────────────────────────────────────────────── */
    (_t = get('flex-direction')) === null || _t === void 0 ? void 0 : _t.addEventListener('change', () => {
        component.style.flexDirection =
            get('flex-direction').value;
        captureStateDebounced();
    });
    (_u = get('align-items')) === null || _u === void 0 ? void 0 : _u.addEventListener('change', () => {
        component.style.alignItems = get('align-items').value;
        captureStateDebounced();
    });
    (_v = get('justify-content')) === null || _v === void 0 ? void 0 : _v.addEventListener('change', () => {
