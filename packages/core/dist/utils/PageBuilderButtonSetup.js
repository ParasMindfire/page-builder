...
export function setupSaveButton(jsonStorage) {
    ...
    saveButton.addEventListener('click', () => {
        ...
        (_a = jsonStorage === null || jsonStorage === void 0 ? void 0 : jsonStorage.save) === null || _a === void 0 ? void 0 : _a.call(jsonStorage, layoutJSON);
...
export function setupResetButton(jsonStorage) {
    ...
    resetButton.addEventListener('click', () => {
        showDialogBox('Are you sure you want to reset the layout?', () => {
            jsonStorage.remove();
            Canvas.clearCanvas();
...
export function setupPreviewModeButtons(previewPanel) {
    var _a, _b, _c;
    (_a = document.getElementById('preview-desktop')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
        previewPanel.setPreviewMode('desktop');
    });
    (_b = document.getElementById('preview-tablet')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
        previewPanel.setPreviewMode('tablet');
    });
    (_c = document.getElementById('preview-mobile')) === null || _c === void 0 ? void 0 : _c.addEventListener('click', () => {
