import { createModalElement, renderForm, filterAttributes, handleSave, } from './ModalCore.js';
/**
...
export class ModalComponent {
    constructor() {
        ...
        (_a = this.modalElement
            .querySelector('#close-modal-button')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            var _a;
            this.hide();
            (_a = this.resolvePromise) === null || _a === void 0 ? void 0 : _a.call(this, null);
        });
        /** Save button collects the selected field and resolves the promise */
        (_b = this.modalElement
            .querySelector('#save-button')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            handleSave(this.contentContainer, this.attributes, (result) => {
                var _a;
                (_a = this.resolvePromise) === null || _a === void 0 ? void 0 : _a.call(this, result);
                this.resolvePromise = null;
            }, () => this.hide());
        });
        /** Live search filters the visible attribute fields */
        (_c = this.modalElement
            .querySelector('#attribute-search')) === null || _c === void 0 ? void 0 : _c.addEventListener('input', event => {
