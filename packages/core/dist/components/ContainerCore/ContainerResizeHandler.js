...
import { RESIZER_POSITIONS } from '../../constants.js';
import { MINIMUM_SIZE } from '../../constants.js';
...
export class ContainerResizeHandler {
    ...
    initResize(e, resizer) {
        ...
        this.originalWidth = parseFloat(getComputedStyle(this.element).getPropertyValue('width'));
        this.originalHeight = parseFloat(getComputedStyle(this.element).getPropertyValue('height'));
