...
import { injectResizerStyles, ContainerResizeHandler, initContainerEventListeners, restoreContainer, } from './ContainerCore.js';
export class ContainerComponent {
    constructor() {
        ...
        if (Canvas.layoutMode === 'absolute') {
            const resizeHandler = new ContainerResizeHandler(this.element, this.resizers);
