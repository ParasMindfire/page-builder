...
export class CanvasDragHandler {
    ...
    static addDraggableListeners(element) {
        ...
        element.addEventListener('dragend', (event) => {
            ...
            const dragStartMouseY = dragStartY - canvasRectStart.top + canvasScrollStartY;
            ...
            const actualMouseX = event.clientX - canvasRect.left + canvasEl.scrollLeft;
            ...
            if (CanvasSharedState.layoutMode === 'absolute' &&
                ...
                const innerContentRightX = canvasEl.offsetWidth - paddingRight - elementWidth;
