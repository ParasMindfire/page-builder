...
export class CanvasInitializer {
    static init(initialData = null, editable, basicComponentsConfig, layoutMode) {
        ...
        CanvasEventDispatcher.attachDropListeners(CanvasDropHandler.onDrop.bind(CanvasDropHandler));
        ...
        CanvasSharedState.controlsManager = new ComponentControlsManager(canvasElement);
    ...
    static applyComponentConfigs(basicComponentsConfig) {
        ...
        CanvasSharedState.tableAttributeConfig = (_a = find('table')) === null || _a === void 0 ? void 0 : _a.attributes;
        CanvasSharedState.textAttributeConfig = (_b = find('text')) === null || _b === void 0 ? void 0 : _b.attributes;
        CanvasSharedState.headerAttributeConfig = (_c = find('header')) === null || _c === void 0 ? void 0 : _c.attributes;
        CanvasSharedState.ImageAttributeConfig = (_d = find('image')) === null || _d === void 0 ? void 0 : _d.globalExecuteFunction;
    }
}
